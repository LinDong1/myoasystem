...
<dl class="leftmenu">
    <dd>
        ...
        <ul class="menuson">
            ...
            <li><cite></cite><a href="showDeptList" target="rightFrame">部门管理</a><i></i></li>
            <li><cite></cite><a href="positionAdd" target="rightFrame">添加岗位</a><i></i></li>
            <li><cite></cite><a href="showPositionList" target="rightFrame">岗位管理</a><i></i></li>
            <li><cite></cite><a href="empAddBefore" target="rightFrame">添加员工</a><i></i></li>
            <li><cite></cite><a href="showEmpList/1" target="rightFrame">员工管理</a><i></i></li>
        </ul>
    </dd>
    <dd>
        ...
        <ul class="menuson">
            ...
            <li><cite></cite><a href="dutyList" target="rightFrame">考勤管理</a><i></i></li>
    ...
    <dd>
        ...
        <ul class="menuson">
            <li><cite></cite><a href="expenseAdd" target="rightFrame">添加报销</a><i></i></li>
            <li><cite></cite><a href="toAudit" target="rightFrame">待审报销</a><i></i></li>
    ...
    <dd>
        ...
        <ul class="menuson">
            <li><cite></cite><a href="myInfo" target="rightFrame">我的信息</a><i></i></li>
            <li><cite></cite><a href="myPwd" target="rightFrame">修改密码</a><i></i></li>
        </ul>
    </dd>
</dl>
