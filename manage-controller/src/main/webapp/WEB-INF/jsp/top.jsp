...
<div class="topleft">
    <a href="main" target="_parent"><img src="images/logo.png" title="系统首页" /></a>
</div>
...
<ul class="nav">
    ...
    <li><a href="empList"  target="rightFrame"><img src="images/icon03.png" title="员工管理" /><h2>员工管理</h2></a></li>
    ...
    <li><a href="myInfo"  target="rightFrame"><img src="images/icon06.png" title="我的信息" /><h2>我的信息</h2></a></li>
</ul>

<div class="topright">
    <ul>
        <li><span><img src="images/help.png" title="帮助" class="helpimg"/></span><a href="tech" target="rightFrame">帮助</a></li>
        <li><a href="logout" target="_parent">退出</a></li>
    </ul>

    <div class="user">
        <span><a href="myInfo" target="rightFrame">${employee.realname}</a></span>
    </div>
