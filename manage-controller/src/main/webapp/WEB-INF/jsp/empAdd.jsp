...
<div class="formbody">
    ...
    <form method="post" action="goEmpAdd">
        ...
        <ul class="forminfo">
            ...
            <li>
                <label>出生日期</label>
                <input name="sbirthdate" type="text" class="dfinput" onfocus="WdatePicker({skin:'whyGreen',lang:'en'})" /><i>也可以根据身份证号自动获取</i></li>
            <li>
            <li>
                <label>入职时间</label>
                <input name="shiredate" type="text" class="dfinput" onfocus="WdatePicker()"/><i></i></li>

            <li>
                <label>离职时间</label>
                <input name="sleavedate" type="text" class="dfinput" onfocus="WdatePicker()"/><i></i></li>
            <li>
